...
<i class="fas fa-dollar-sign" style="font-size:1.5em;color:gold;"></i>
        ...
        <div class="left">
            ...
            <div class="info info1">
                <div class="row" style="justify-content: space-between;padding-left: 20px;">
                    ...
                    ?>
                    <h6 style="color: #2d2d2f;"><span style="color: #172646;font-weight:bold;">Numéro de réservation:</span><?php echo $_SESSION['num_reserv']; ?></h6>
                    <h6 style="color: #2d2d2f;"><span style="color: #172646;font-weight:bold;"></span>Le total: </span><?php echo $total_avc_tax.' '.$_SESSION['devise']; ?></h6>
                    <p style="color: black;
                    font-weight: 600;margin-left: 0px;">Vous avez un delai de 3h pour confirmer votre voyage, si le paiement n'est pas effectuer votre reservation sera annulée</p>
                </div>
    ...
    ?>
            ...
            <div class="info" style="background-color: #172646;height: 70px;">
                <div class="row " style="display: flex;">
                    ...
                    <h5 style="color: white;"><?php echo $data['nom'].' '.$data['prenom']; ?></h5>
                </div>
    ...
    <div class="ident" style="width: 50%;margin:auto;">
            ...
            <div class="flex" style="align-items: baseline;justify-content: center;">
                    <div style="margin-right:20px;">
                     <select name="identite" id="identité"   required style="display: block;">
                            <option value="" disabled selected>identifiez vous</option>
                            <?php
    ...
    <div class=" details_vol ">
         ...
         <div style="height: auto; margin-top:0px;width: 100%;"  >
            <div id="myDIV" style="display: block;padding:20px 10px;">
                <ul class="list1">
               <li style="font-size:20px;color:#172646;font-weight:bold"><?php echo $nbr_passager.' '.'Voyageurs :'; ?></li>
        ...
        $heure_dep_r=$donnee33['heure_dep_r'];
        $heure_arr_r=$donnee33['heure_arr_r'];
        ...
        $av_nom_r=$donnee33['nom'];
               ...
               <li><?php echo 'PRIX :'.$tarif_vol_r; ?></li>
                ...
                <div id="myDIV" style="display: block;padding:20px 10px;">
                    <ul class="list1">
                    <li>Frais de transport aérien : <?php echo $total.' '.$_SESSION['devise']; ?></li>
                    <li>Taxes et frais : <?php echo $taxe_tt.' '.$_SESSION['devise']; ?></li>
                     <li>Total : <?php echo $total_avc_tax.' '.$_SESSION['devise']; ?></li>
                    </ul>
                </div>
