...
class myPDF extends FPDF{
  ...
  function footer(){
      ...
      $this->Cell(0,10,'Notre compagnie vous souhaite un agreable voyage',0,0,'C');
       ...
       $pdf->Cell(90,5,$pays_dep,0,0,'C');
       $pdf->Cell(90,5,$pays_arr,0,0,'C');
       ...
       $pdf->Cell(90,5,$aero_dep,0,0,'C');
       $pdf->Cell(90,5,$aero_arr,0,0,'C');
       $pdf->Cell(30,5,$av_nom,0,1,'C');
       $pdf->Cell(442,5,$classe,0,1,'C');
       $pdf->Ln(10);
        ...
        $pdf->Cell(90,5,$pays_dep_r,0,0,'C');
        $pdf->Cell(90,5,$pays_arr_r,0,0,'C');
       // $this->Cell(45,10,$aero_dep,1,0,'C');
        ...
        $pdf->Cell(90,5,$aero_dep_r,0,0,'C');
        $pdf->Cell(90,5,$aero_arr_r,0,0,'C');
